...
# generate a Pydantic model of class text
...
def checksum(body: Text):
    """
    Accepts a POST request with a JSON body containing a single field called "text" and returns a checksum of the text.
